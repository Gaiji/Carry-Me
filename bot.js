	...
	request(url, function(err, response, body) {
		...
		let lastlogin;
			...
			if (body.player.stats.UHC.equippedKit == "LEATHER_ARMOR") {
			    ...
			    .addField("Monthly Wins Solo", zero(body.player.stats.UHC.monthly_wins__solo_a), true)
			    .addField("Monthly Wins Teams", zero(body.player.stats.UHC.monthly_wins), true)
